...
func Test_handleCommand_decrypt_v1(t *testing.T) {
	decryptArgs := []string{"situ-vault", "decrypt", "-password=test-pw", "-ciphertext=SITU_VAULT_V1##C:AES256_GCM#KDF:PBKDF2_SHA256_I10K#SALT:R8B#ENC:BASE32#LB:NO##TNSIVLVV6EOGI===##GRDENILPW24R4YDA2I6MKT6JPLG5GM2HWC5S2PR7##END"}
	resultDecrypted := handleCommand(decryptArgs)
